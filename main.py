...
# # while True:
# #longs 70%
# # dailyscanner('VeryLargeStocks/(30,)D-uptrend03-28-21.json', '>', publish=False)
# # dailyscanner('VeryLargeStocks/(20,)D-uptrend03-28-21.json', '>')
# dailyscanner('VeryLargeStocks/(5,)D-uptrend03-28-21.json', '>', publish=False)
# # dailyscanner('LargeStocks/(30,)D-uptrend03-28-21.json', '>', publish=False)
# # dailyscanner('LargeStocks/(25,)D-uptrend03-28-21.json', '>')
# # dailyscanner('LargeStocks/(20,)D-uptrend03-28-21.json', '>')
# # dailyscanner('LargeStocks/(5,)D-uptrend03-28-21.json', '>', publish=False)
# dailyscanner('MediumStocks/(30,)D-uptrend03-28-21.json', '>', publish=False)
# # dailyscanner('MediumStocks/(25,)D-uptrend03-28-21.json', '>')
# # dailyscanner('MediumStocks/(20,)D-uptrend03-28-21.json', '>')
# # dailyscanner('MediumStocks/(5,)D-uptrend03-28-21.json', '>', publish=False)
# dailyscanner('SmallStocks/(5,)D-uptrend03-28-21.json', '>', publish=False)
# dailyscanner('MicroStocks/(5,)D-uptrend03-28-21.json', '>', publish=False)
